...
import "./Intro.scss"
import givePng from '../../layouts/PngFunction'
const Intro = () => {
  const images = ["SotsLeft","SotsRight","SotsTablet","SotsPhone","SotMouse","SotHeadphones","SotDisplay","SotKeyBoard","SotArmchair","SotLaptop"]
  return (
    <div id='intro'>
