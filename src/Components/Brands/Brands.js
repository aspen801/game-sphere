  ...
  return (
    <div className='brands'>
        <div className='brands_container'>
            ...
            <ul>
                <li><img src={asusLogo} alt='LogoBrands'/></li>
                <li><img src={sonyLogo} alt='LogoBrands'/></li>
                <li><img src={lenovoLogo} alt='LogoBrands'/></li>
                <li><img src={acerLogo} alt='LogoBrands'/></li>
                <li><img src={samsungLogo} alt='LogoBrands'/></li>
                <li><img src={corsairLogo} alt='LogoBrands'/></li>
            </ul>
        </div>
    </div>
  )
