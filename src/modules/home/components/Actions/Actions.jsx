...
const Actions = () => {
  ...
  return (
    <div className="actions">
      ...
      <img
        src={actionSotsLeftTab}
        className="action_sots_left_tab"
        alt="sots"
      />
      <img
        src={actionSotsRightTab}
        className="action_sots_right_tab"
        alt="sots"
      />
      <img
        src={actionSotsRightMobile}
        className="action_sots_right_Mobile"
        alt="sots"
      />
      <div className="actions_container">
        <Carousel
          className="actions_carousel"
          itemsToShow={1}
